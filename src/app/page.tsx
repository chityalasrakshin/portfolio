          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFade delay={BLUR_FADE_DELAY}>
                <h2 className="max-w-[600px] text-xl font-medium text-muted-foreground">
      ...
      <section id="volunteering">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 12}>
            <h2 className="text-xl font-bold">Leadership & Involvement</h2>
          </BlurFade>
          {DATA.volunteering.map((volunteer, id) => (
            <BlurFade
              key={volunteer.company}
              delay={BLUR_FADE_DELAY * 13 + id * 0.05}
            >
              <ResumeCard
                key={volunteer.company}
                logoUrl={volunteer.logoUrl}
                altText={volunteer.company}
